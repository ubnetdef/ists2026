...
if defined REMOVED_USERS (
  echo - Local users removed: %REMOVED_USERS%
) else (
  echo - Local users removed: (none)
)
if defined FAILED_USERS echo - Local users FAILED to remove: %FAILED_USERS%
...
echo - Desktop Goose removal attempted
echo ========================================
